...
public class FareController 
{
	...
	public String addFlightDetails(@Valid FlightDetails flightDetails)
	{
	...
	public FlightDetails updateFlightDetails(@PathVariable Integer flightNo,@Valid  FlightDetails flightDetails)
	{
