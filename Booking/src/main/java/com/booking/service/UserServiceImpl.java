...
//System.out.println(x);
	...
	public void sendEmail(long pnrNo) throws AddressException {
		...
		final Email email = DefaultEmail.builder().from(new InternetAddress("shradha1631@gmail.com.com"))
				.replyTo(new InternetAddress("shradha1631@gmail.com"))
				.to(Lists.newArrayList(new InternetAddress("shradha1631@gmail.com"))).subject("Your Flight is booked")
