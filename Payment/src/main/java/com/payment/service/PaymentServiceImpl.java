...
public class PaymentServiceImpl implements PaymentService
{
	...
	public void sendEmail(PaymentDetails payment) throws AddressException{
		final Email email = DefaultEmail.builder()
			      .from(new InternetAddress("shradha1631@gmail.com"))
			      .replyTo(new InternetAddress("shradha1631@gmail.com"))
			      .to(Lists.newArrayList(new InternetAddress("shradha1631@gmail.com")))
